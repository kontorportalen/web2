...
<section class="py-20 z-5 bg-blue-100" id="steg1" aria-label="Steg 1">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-base font-semibold tracking-wide text-indigo-600 uppercase">Steg 1</h2>
        ...
        <div>
            ...
            Dersom dere ikke allerede eier domenenavnet eller skal ha webhotell og tilsvarende tekniske ting, vil vi løse det i Steg 1.
            </p>
        </div>
    </div>
</section>

<section class="py-20 z-5 bg-white" id="steg2" aria-label="Steg 2">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-base font-semibold tracking-wide text-indigo-600 uppercase">Steg 2</h2>
            <p class="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-900 sm:text-4xl">
                Første utkast
            </p>
        </div>
...
<section class="py-20 z-5 bg-blue-100" id="steg3" aria-label="Steg 3">
    <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-base font-semibold tracking-wide text-indigo-600 uppercase">Steg 3</h2>
            <p class="mt-2 text-3xl font-extrabold leading-8 tracking-tight text-gray-900 sm:text-4xl">
